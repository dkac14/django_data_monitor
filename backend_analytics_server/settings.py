...
SECRET_KEY = "django-insecure-efnnim5eid1=9q9ejb&qz_m#$l0*d8!y)f=lzim-dx9_m2zq4h"
...
INSTALLED_APPS = [
    ...
    'dashboard',  # <--- Agrega tu aplicación aquí
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # <--- Agrega esta línea para que lea la carpeta templates de la raíz
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
